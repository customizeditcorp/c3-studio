...
export default function GBPIndexPage() {
  ...
  const loadClients = async () => {
    ...
    if (error) {
      toast.error('Error cargando clientes para GBP');
      setClients([]);
    } else {
      setClients(data || []);
    }
  ...
  return (
    <PageContainer
      pageTitle='Perfil GBP — elegir cliente'
      pageDescription='Selecciona un cliente para administrar su Google Business Profile'
    >
