...
export default function CredentialsIndexPage() {
  ...
  const loadClients = async () => {
    ...
    if (error) {
      toast.error('Error cargando clientes para Credenciales');
      setClients([]);
    } else {
      setClients(data || []);
    }
  ...
  return (
    <PageContainer
      pageTitle='Credenciales — elegir cliente'
      pageDescription='Selecciona el cliente para administrar el checklist de credenciales'
    >
